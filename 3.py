...
def student_list(students, class_list):
    for i, student in enumerate(students):
        
        if i < len(class_list):
            yield student, class_list[i]

        else:
            yield student, None


tutors = ['Иван', 'Анастасия', 'Петр', 'Сергей', 'Дмитрий', 'Борис', 'Елена', 'Станислав', 'Владислав']
klasses = ['9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А']

print(student_list(tutors, klasses))
print(*student_list(tutors, klasses))
