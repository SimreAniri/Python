...
"""
Вопрос в том, нужно ли скачать файл или работать прямо с сервера. Я реализовала вариант со скаченным файлом.
Как сделать это на ходу, остается загадкой, т.к. я не могу гарантировать разбивку четко по строкам(((
"""
